...
## [4.4.0](https://github.com/cuyl/shaka-player/compare/v4.3.0...v4.4.0) (2023-02-15)


### Features

* Add AC-3 detection in TS ([#4931](https://github.com/cuyl/shaka-player/issues/4931)) ([48c30bc](https://github.com/cuyl/shaka-player/commit/48c30bcd036060a09175badadeeacdff4d8f3728))
* Add ExpressPlay FairPlay util ([#4926](https://github.com/cuyl/shaka-player/issues/4926)) ([7fa40fd](https://github.com/cuyl/shaka-player/commit/7fa40fdb483e155099d0141ee110ac1a791d88ae))
* add Occitan locale ([#4900](https://github.com/cuyl/shaka-player/issues/4900)) ([68486a3](https://github.com/cuyl/shaka-player/commit/68486a3f3743946188827aa0ebf6ef0e321153be))
* Add preferredAudioLabel to PlayerConfiguration ([#4763](https://github.com/cuyl/shaka-player/issues/4763)) ([aadecd6](https://github.com/cuyl/shaka-player/commit/aadecd6401c00af56eccc26bd710d96d41be76ce))
* Add support for Document Picture-in-Picture ([#4969](https://github.com/cuyl/shaka-player/issues/4969)) ([3828fd6](https://github.com/cuyl/shaka-player/commit/3828fd6849fba98218ed934279d5d8a23183dc06))
* Allow custom plugins for transmuxing ([#4854](https://github.com/cuyl/shaka-player/issues/4854)) ([fac721d](https://github.com/cuyl/shaka-player/commit/fac721df868af2a4a53f5454b1838a60da3cee83))
* Allow VTT files with erroneous linebreaks ([#2394](https://github.com/cuyl/shaka-player/issues/2394)) ([9b1c614](https://github.com/cuyl/shaka-player/commit/9b1c614815d4963e03dec41a155e58cb5eefb94f)), closes [#2358](https://github.com/cuyl/shaka-player/issues/2358)
* Cache mediaCapabilities.decodingInfo results ([#4789](https://github.com/cuyl/shaka-player/issues/4789)) ([b7781f0](https://github.com/cuyl/shaka-player/commit/b7781f04468c0e25502679a7bc740cc024551adf)), closes [#4775](https://github.com/cuyl/shaka-player/issues/4775)
* Caching and other efficiency improvements for mcap polyfill ([#4708](https://github.com/cuyl/shaka-player/issues/4708)) ([884c4ca](https://github.com/cuyl/shaka-player/commit/884c4ca4f8ed94457e7eabce68d4e476811739d5)), closes [#4574](https://github.com/cuyl/shaka-player/issues/4574)
* **cea:** Add CEA parser for TS ([#4697](https://github.com/cuyl/shaka-player/issues/4697)) ([70fad8d](https://github.com/cuyl/shaka-player/commit/70fad8de8fc18cdd186ee431bbd433bbd4d440cc))
* Config to require a minimum HDCP version ([#4883](https://github.com/cuyl/shaka-player/issues/4883)) ([61613cf](https://github.com/cuyl/shaka-player/commit/61613cf0ee8bdbcbf7bfee209bba4fe052f8857c))
* **DASH:** Add support for &lt;dashif:Laurl&gt; ([#4849](https://github.com/cuyl/shaka-player/issues/4849)) ([b441518](https://github.com/cuyl/shaka-player/commit/b441518943241693fa2df03196be6ee707c8511e)), closes [#4748](https://github.com/cuyl/shaka-player/issues/4748)
* Enable variant failover for BAD_HTTP_STATUS and TIMEOUT ([#4769](https://github.com/cuyl/shaka-player/issues/4769)) ([b46012d](https://github.com/cuyl/shaka-player/commit/b46012df647d0fd6f1b6209a324171ab86f9fa80))
* **HLS:** Add HLS support for non-sequence mode ([#4623](https://github.com/cuyl/shaka-player/issues/4623)) ([2b50b88](https://github.com/cuyl/shaka-player/commit/2b50b88030d44c841daea8f67a3c51eb9b2284a4))
* **HLS:** Add support to HLS-AES128 low latency ([#4982](https://github.com/cuyl/shaka-player/issues/4982)) ([07787a8](https://github.com/cuyl/shaka-player/commit/07787a8874f8448df66e487a5485155a00e39b0c))
* **HLS:** Improve detection of basic info from Media Playlist ([#4809](https://github.com/cuyl/shaka-player/issues/4809)) ([d465942](https://github.com/cuyl/shaka-player/commit/d465942c4393e6c891d6a230bea90a44d90cc70b))
* **HLS:** Improve Low Latency performance in HLS ([#4952](https://github.com/cuyl/shaka-player/issues/4952)) ([5514385](https://github.com/cuyl/shaka-player/commit/5514385c87440b4e77ae772f533b30927dcdb303))
* **HLS:** Poll HLS playlists using last segment duration ([#4779](https://github.com/cuyl/shaka-player/issues/4779)) ([1ba3806](https://github.com/cuyl/shaka-player/commit/1ba38067759654b5e53573c41db65d9d748af003)), closes [#4771](https://github.com/cuyl/shaka-player/issues/4771)
* **logs:** Add extra logging for 3015 errors ([#4932](https://github.com/cuyl/shaka-player/issues/4932)) ([67a2451](https://github.com/cuyl/shaka-player/commit/67a245129f53d99cce89aff3ea194b1098d65ee6))
* Move forceTransmux from streaming to mediasource config ([#4783](https://github.com/cuyl/shaka-player/issues/4783)) ([b491a6b](https://github.com/cuyl/shaka-player/commit/b491a6b7caa5d4a8167adf18cf90b23c30a5a1be))
* Support customizing clearBuffers and safeMargin when select variants by label ([#4770](https://github.com/cuyl/shaka-player/issues/4770)) ([c724625](https://github.com/cuyl/shaka-player/commit/c7246250323c3c97a2d30f9f66880e914e5c2344))
* Support Parallel Segment Fetching ([#4784](https://github.com/cuyl/shaka-player/issues/4784)) ([de6abde](https://github.com/cuyl/shaka-player/commit/de6abde06f38d802f1f9fb297c284283ca8e4751))
* **UI:** Allow customizing FullScreen element ([#4963](https://github.com/cuyl/shaka-player/issues/4963)) ([c471d23](https://github.com/cuyl/shaka-player/commit/c471d23bc25db11dda85a18870ebd3fe37971848))
* **webvtt:** webvtt colors output ([#4954](https://github.com/cuyl/shaka-player/issues/4954)) ([ed7a736](https://github.com/cuyl/shaka-player/commit/ed7a736ca22bb768672135ad0d468c00be4c5dac))


### Bug Fixes

* Add mux.js to support.html ([#4923](https://github.com/cuyl/shaka-player/issues/4923)) ([d9fa4eb](https://github.com/cuyl/shaka-player/commit/d9fa4ebdec49b609690b4d028a0fa1318b83f179))
* **ads:** Fix VMAP ads stay muted on muted autoplay ([#4995](https://github.com/cuyl/shaka-player/issues/4995)) ([d074afc](https://github.com/cuyl/shaka-player/commit/d074afc1fc1a675aaee7059df860a160004871fc))
* Caption can not turn off at iOS Safari ([#4978](https://github.com/cuyl/shaka-player/issues/4978)) ([9d2c325](https://github.com/cuyl/shaka-player/commit/9d2c325cdf431664d33bca31626f73d5c6f7a608))
* **cast:** Added existence checks for MediaDecodingConfig.{audio|video} in decodingInfo(). ([#4796](https://github.com/cuyl/shaka-player/issues/4796)) ([36db83d](https://github.com/cuyl/shaka-player/commit/36db83dc992bf86e08c610f31ef39ae2c41d0130))
* **cast:** Use cast platform APIs in MediaCapabilties polyfill ([#4727](https://github.com/cuyl/shaka-player/issues/4727)) ([5d6f56a](https://github.com/cuyl/shaka-player/commit/5d6f56adf33557ca3ff70a0c459d400b2eae6f79))
* **cea:** Fix MAX_ROWS in CEA-708 window ([#4757](https://github.com/cuyl/shaka-player/issues/4757)) ([e89eeb6](https://github.com/cuyl/shaka-player/commit/e89eeb69fab877ee6b330f12c4ff67b3eeac8839))
* **cea:** Fix not rendering CEA-608 on encrypted mp4 segments ([#4756](https://github.com/cuyl/shaka-player/issues/4756)) ([d600109](https://github.com/cuyl/shaka-player/commit/d6001097a9751bd9211eb52f940e282ead026a32))
* **chapters:** removed duplicate chapters by id ([#4810](https://github.com/cuyl/shaka-player/issues/4810)) ([151bdda](https://github.com/cuyl/shaka-player/commit/151bdda36d60499f5cfdd4d5c6ebbe088025cd2a))
* Correct default initDataTransform for legacy Apple Media Keys ([#4797](https://github.com/cuyl/shaka-player/issues/4797)) ([67a5d56](https://github.com/cuyl/shaka-player/commit/67a5d56e8606c58cef6ff969aca6010e6db2dd16))
* **DASH:** Fix dynamic manifests from edgeware ([#4914](https://github.com/cuyl/shaka-player/issues/4914)) ([056588b](https://github.com/cuyl/shaka-player/commit/056588b2e1eaf2e627cb8878735f4db5d0d04087))
* **Demo:** Allow manifest type for DAI custom assets ([#4977](https://github.com/cuyl/shaka-player/issues/4977)) ([1e50630](https://github.com/cuyl/shaka-player/commit/1e50630ad4631cd2455f0e8a179012de34935a80))
* DrmEngine exception thrown when using FairPlay ([#4971](https://github.com/cuyl/shaka-player/issues/4971)) ([eebf18c](https://github.com/cuyl/shaka-player/commit/eebf18cabdcee3c62daee9bed9ceb2958f30f9f5))
* Explicitly specify [@externs](https://github.com/externs) in transmuxer externs. ([#4999](https://github.com/cuyl/shaka-player/issues/4999)) ([ef8078a](https://github.com/cuyl/shaka-player/commit/ef8078a05f5b56cc4cabe7e6b78e14a5d26b89ce))
* Failed to set 'currentTime' property on 'HTMLMediaElement' on a Hisense TV ([#4962](https://github.com/cuyl/shaka-player/issues/4962)) ([5d93b8f](https://github.com/cuyl/shaka-player/commit/5d93b8f9a71214b984db45db3cda7ba40d86ff87))
* Fix bufferBehind setting broken by image segments ([#4718](https://github.com/cuyl/shaka-player/issues/4718)) ([cd1b7c0](https://github.com/cuyl/shaka-player/commit/cd1b7c09429f9d13361a5ab1fdfb79940673f941)), closes [#4717](https://github.com/cuyl/shaka-player/issues/4717)
* Fix compiler error on static use of "this" ([#4699](https://github.com/cuyl/shaka-player/issues/4699)) ([b06fd6a](https://github.com/cuyl/shaka-player/commit/b06fd6ad27b38238c401867971ce6b0ac1e53882))
* Fix DRM workaround for Tizen and Xbox with hvc1/hev1 boxes ([#4743](https://github.com/cuyl/shaka-player/issues/4743)) ([a61c084](https://github.com/cuyl/shaka-player/commit/a61c08433dab654edd224b2dc930c6d257460ec9)), closes [#4742](https://github.com/cuyl/shaka-player/issues/4742)
* Fix duplicate updates in StreamingEngine ([#4840](https://github.com/cuyl/shaka-player/issues/4840)) ([224207b](https://github.com/cuyl/shaka-player/commit/224207ba6caf49b2cdb7434a0534df8210bc4be9)), closes [#4831](https://github.com/cuyl/shaka-player/issues/4831)
* Fix exception enabling captions on HLS ([#4894](https://github.com/cuyl/shaka-player/issues/4894)) ([b7b2a7c](https://github.com/cuyl/shaka-player/commit/b7b2a7cbe9f1b23ca184617a2c51f26cc85bf0a3)), closes [#4889](https://github.com/cuyl/shaka-player/issues/4889)
* Fix flattenedCues in WebVttGenerator ([#4867](https://github.com/cuyl/shaka-player/issues/4867)) ([15232dd](https://github.com/cuyl/shaka-player/commit/15232ddf06294f7f932b2a97f619e6ff87514a6c))
* Fix legacy codec support by rewriting codec metadata ([#4858](https://github.com/cuyl/shaka-player/issues/4858)) ([e351395](https://github.com/cuyl/shaka-player/commit/e351395c4a78ccc9e3ceafaa0288cbd06489a927))
* Fix media source duration when using sequence mode ([#4848](https://github.com/cuyl/shaka-player/issues/4848)) ([1762267](https://github.com/cuyl/shaka-player/commit/1762267d356a04217340ec792c51ceadb842cd6a))
* Fix MediaCapabilities polyfill on Hisense ([#4927](https://github.com/cuyl/shaka-player/issues/4927)) ([6a48cfe](https://github.com/cuyl/shaka-player/commit/6a48cfe64da49c49aeaabeb646b0233537a2ae3e))
* Fix parsing error on Chromecast when resyncing HLS ([#4869](https://github.com/cuyl/shaka-player/issues/4869)) ([afca6af](https://github.com/cuyl/shaka-player/commit/afca6af230685a0c9b556fddb46341380b611923)), closes [#4589](https://github.com/cuyl/shaka-player/issues/4589)
* Fix potential AV sync issues after seek or adaptation ([#4886](https://github.com/cuyl/shaka-player/issues/4886)) ([c42565c](https://github.com/cuyl/shaka-player/commit/c42565ccb9c69455307742e1f5c3c763892ec1c6)), closes [#4589](https://github.com/cuyl/shaka-player/issues/4589)
* Fix potential duplicate segments, AV sync issues ([#4884](https://github.com/cuyl/shaka-player/issues/4884)) ([52f4b63](https://github.com/cuyl/shaka-player/commit/52f4b638b155b4b7f7f6a0bd14e6e9661d5cceba)), closes [#4589](https://github.com/cuyl/shaka-player/issues/4589)
* Fix rare exception after StreamingEngine teardown ([#4830](https://github.com/cuyl/shaka-player/issues/4830)) ([234beef](https://github.com/cuyl/shaka-player/commit/234beefb73ea7f8a7442112eb2efb78d619a13cb)), closes [#4813](https://github.com/cuyl/shaka-player/issues/4813)
* Fix subtitles not added to DOM region ([#4733](https://github.com/cuyl/shaka-player/issues/4733)) ([4081434](https://github.com/cuyl/shaka-player/commit/4081434eba7f90ea7fe8544665baf99f59ec5863)), closes [#4680](https://github.com/cuyl/shaka-player/issues/4680)
* Fix timestamp offset for ID3 on DAI-HLS ([#4696](https://github.com/cuyl/shaka-player/issues/4696)) ([386a28a](https://github.com/cuyl/shaka-player/commit/386a28a8eb0cd995e7eee9f95c97b7f8e7542774))
* Fix usage of WebCrypto in old browsers ([#4711](https://github.com/cuyl/shaka-player/issues/4711)) ([9afce3b](https://github.com/cuyl/shaka-player/commit/9afce3b423406aae0cd2841bb39071c90196c792))
* Fix WebVTT parser failure on REGION blocks ([#4915](https://github.com/cuyl/shaka-player/issues/4915)) ([da84a2c](https://github.com/cuyl/shaka-player/commit/da84a2c86b7d7e6968472ce9d2bbe09e0608dbef))
* **HLS:** Fix AV sync over ad boundaries ([#4824](https://github.com/cuyl/shaka-player/issues/4824)) ([35033bb](https://github.com/cuyl/shaka-player/commit/35033bb2db1ca630f4f7895e7678bd0ee6cfd9ef)), closes [#4589](https://github.com/cuyl/shaka-player/issues/4589)
* **HLS:** Fix detection of Media Playlist for audio and video only in MP4 ([#4803](https://github.com/cuyl/shaka-player/issues/4803)) ([76f96b9](https://github.com/cuyl/shaka-player/commit/76f96b9fee2dc43b03f6803dd80c51fdc5b73a9e))
* **HLS:** Fix detection of WebVTT subtitles in HLS by extension ([#4928](https://github.com/cuyl/shaka-player/issues/4928)) ([15b0388](https://github.com/cuyl/shaka-player/commit/15b03884bb61542f451f7854a8562aa3d759ed0f)), closes [#4929](https://github.com/cuyl/shaka-player/issues/4929)
* **HLS:** Fix discontinuity tracking ([#4881](https://github.com/cuyl/shaka-player/issues/4881)) ([fc3d5c1](https://github.com/cuyl/shaka-player/commit/fc3d5c144708c748d90f25de34c436495db2a816)), closes [#4589](https://github.com/cuyl/shaka-player/issues/4589)
* **HLS:** fix lazy load with multiple raw audio tracks ([#4715](https://github.com/cuyl/shaka-player/issues/4715)) ([76149ae](https://github.com/cuyl/shaka-player/commit/76149ae7453ccff852483b437c9de72cb6ebfbf5))
* **HLS:** Fix lowLatencyPresentationDelay when using autoLowLatencyMode ([#4712](https://github.com/cuyl/shaka-player/issues/4712)) ([877e954](https://github.com/cuyl/shaka-player/commit/877e9542170aa0467d28b5edb5a4b1b29dd4452e))
* **HLS:** Fix missing roles ([#4760](https://github.com/cuyl/shaka-player/issues/4760)) ([2bc481d](https://github.com/cuyl/shaka-player/commit/2bc481decd11ec1db93e3bb5ca0db4a644b13269)), closes [#4759](https://github.com/cuyl/shaka-player/issues/4759)
* **HLS:** Fix support for mixed AES-128/NONE decryption ([#4847](https://github.com/cuyl/shaka-player/issues/4847)) ([452694d](https://github.com/cuyl/shaka-player/commit/452694d59785f2e88cab607618f10ba980851805))
* **HLS:** Fix support legacy AVC1 codec used in HLS ([#4716](https://github.com/cuyl/shaka-player/issues/4716)) ([c3ff8e5](https://github.com/cuyl/shaka-player/commit/c3ff8e5e5f6ad5867ed0650e153627dafcb1bcf7))
* **hls:** Fix type error in lazy-loading ([#4687](https://github.com/cuyl/shaka-player/issues/4687)) ([28b73b9](https://github.com/cuyl/shaka-player/commit/28b73b921d1dbdc6d7e016aa8e0a000e62318ed3))
* **HLS:** IMSC1 subtitles not working in a HLS stream ([#4942](https://github.com/cuyl/shaka-player/issues/4942)) ([974f5dc](https://github.com/cuyl/shaka-player/commit/974f5dcb630977fcdb8ac67d1af001919cf40f7f))
* **HLS:** Single alternative video renditions not working ([#4785](https://github.com/cuyl/shaka-player/issues/4785)) ([6915a97](https://github.com/cuyl/shaka-player/commit/6915a970efead95d41dbe05a824f699e7c68a3a5))
* Increase IndexedDB timeout ([#4984](https://github.com/cuyl/shaka-player/issues/4984)) ([ea290ab](https://github.com/cuyl/shaka-player/commit/ea290ab958385f81ef8ad4ce855100dc21d26667))
* Make encoding problem detection more robust ([#4885](https://github.com/cuyl/shaka-player/issues/4885)) ([0e3621c](https://github.com/cuyl/shaka-player/commit/0e3621c21e914b38640e0c2c8cf9bece6158efad)), closes [#4589](https://github.com/cuyl/shaka-player/issues/4589)
* Manually order key for decodingInfo cache ([#4795](https://github.com/cuyl/shaka-player/issues/4795)) ([806a9a8](https://github.com/cuyl/shaka-player/commit/806a9a81c4e6d16d8affa46010665479bfa5bdff))
* **MCap:** Remove robustness when robustness value is default ([#4953](https://github.com/cuyl/shaka-player/issues/4953)) ([7439a26](https://github.com/cuyl/shaka-player/commit/7439a264d63ff5b68b0411098939eb19708d7134))
* Polyfill missing AbortController on Tizen ([#4707](https://github.com/cuyl/shaka-player/issues/4707)) ([75ef975](https://github.com/cuyl/shaka-player/commit/75ef9752a4c7d618a934da773e35ed4d27a9bdf5))
* Prevent content from being restarted after Postroll ads ([#4979](https://github.com/cuyl/shaka-player/issues/4979)) ([64e94f1](https://github.com/cuyl/shaka-player/commit/64e94f1c79f3eda75e762474502ba2fc70fb9ee2)), closes [#4445](https://github.com/cuyl/shaka-player/issues/4445)
* Prevent error and incorrect duration ([7f4413c](https://github.com/cuyl/shaka-player/commit/7f4413cc3fb0dee76f85e337f3f0b48d197a7e59))
* Release region timeline when unloading ([#4871](https://github.com/cuyl/shaka-player/issues/4871)) ([a236180](https://github.com/cuyl/shaka-player/commit/a2361806ce3b2eab60024cdca81ecb1ea5a0ed8a)), closes [#4850](https://github.com/cuyl/shaka-player/issues/4850)
* Sync each segment against EXT-X-PROGRAM-DATE-TIME ([#4870](https://github.com/cuyl/shaka-player/issues/4870)) ([50c9df4](https://github.com/cuyl/shaka-player/commit/50c9df49a70e17b8b2973ae7a7d47d7856cd09f8)), closes [#4589](https://github.com/cuyl/shaka-player/issues/4589)
* Treat regions uniquely ([#4841](https://github.com/cuyl/shaka-player/issues/4841)) ([5681efe](https://github.com/cuyl/shaka-player/commit/5681efe95cb7e32e2eddd6fcae1b44d265407939)), closes [#4839](https://github.com/cuyl/shaka-player/issues/4839)
* **TTML:** Add font-family mapping ([#4801](https://github.com/cuyl/shaka-player/issues/4801)) ([db8987d](https://github.com/cuyl/shaka-player/commit/db8987d6dfdb59b9f6d187051d47edf6d846a9ed))
* **TTML:** Fix duplicate cues overlapping segment boundaries ([#4798](https://github.com/cuyl/shaka-player/issues/4798)) ([bd75032](https://github.com/cuyl/shaka-player/commit/bd75032d63755044d2d78ca109e2e9f132e36a00)), closes [#4631](https://github.com/cuyl/shaka-player/issues/4631)
* **ui:** Avoid submitting form if player is inside form ([#4866](https://github.com/cuyl/shaka-player/issues/4866)) ([da21850](https://github.com/cuyl/shaka-player/commit/da21850f21ac94fc06349b528a2bf7c17487b681)), closes [#4861](https://github.com/cuyl/shaka-player/issues/4861)
* **ui:** Check event cancelable before event.preventDefault ([#4690](https://github.com/cuyl/shaka-player/issues/4690)) ([6d8de72](https://github.com/cuyl/shaka-player/commit/6d8de72dafa757ac7d00ef7c4acbfab6529b15c2))
* **ui:** Fix iOS fullscreen on rotation ([#4679](https://github.com/cuyl/shaka-player/issues/4679)) ([86256f4](https://github.com/cuyl/shaka-player/commit/86256f49202e64d15f53c7d29e5cac150f018d5c))
* **UI:** Suppress error log from fullscreen button on desktop ([#4823](https://github.com/cuyl/shaka-player/issues/4823)) ([99da4ce](https://github.com/cuyl/shaka-player/commit/99da4ce7dea43ae67870acbcf708ed6479efa7cc)), closes [#4822](https://github.com/cuyl/shaka-player/issues/4822)
* **VTT:** Fix combining style selectors ([#4934](https://github.com/cuyl/shaka-player/issues/4934)) ([128562d](https://github.com/cuyl/shaka-player/commit/128562d93e90ba406c8cbde1af730052fcfc5175))
* **VTT:** Fix spacing between text lines ([#4961](https://github.com/cuyl/shaka-player/issues/4961)) ([2d0469f](https://github.com/cuyl/shaka-player/commit/2d0469fb4a2ee62d67fb9f0dbac8009b667156f2))
* **WebVTT:** Add support to &nbsp;, &lrm; and &rlm; ([#4920](https://github.com/cuyl/shaka-player/issues/4920)) ([726ef42](https://github.com/cuyl/shaka-player/commit/726ef425b095543a216ba8fed0dfe6d1657e2e95))
* **WebVTT:** Fix horizontal positioning with cue box size ([#4949](https://github.com/cuyl/shaka-player/issues/4949)) ([f456318](https://github.com/cuyl/shaka-player/commit/f45631834d363b23eb8897b03bce9b3b1b50ca9a))
* **WebVTT:** Fix voice tag styles ([a5f8b43](https://github.com/cuyl/shaka-player/commit/a5f8b4361e38973c74d0180b5ba7769f636c651d))
* **WebVTT:** Fix voices with styles and support to multiple styles ([#4922](https://github.com/cuyl/shaka-player/issues/4922)) ([68968c1](https://github.com/cuyl/shaka-player/commit/68968c17d8ad1eaca6afa6d86bb4f8b1baa69d10))
* **WebVTT:** Tags in the WebVTT subtitle are not parsed ([#4960](https://github.com/cuyl/shaka-player/issues/4960)) ([d4fc54f](https://github.com/cuyl/shaka-player/commit/d4fc54f8dc68668244b72405b9f972c711b9a868))


### Performance Improvements

* Caching mediaSource support for browser engine ([#4778](https://github.com/cuyl/shaka-player/issues/4778)) ([ad6c085](https://github.com/cuyl/shaka-player/commit/ad6c08561d509cd0cf0e7f4736ba4473774577d9))
